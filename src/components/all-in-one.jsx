...
function AllInOne() {
  return (
    <div className="max-w-[1440px] mx-auto px-6">
        <div className="flex lg:flex-row flex-col xl:gap-30 lg:gap-16  gap-10  py-[92px] ">

      <div className="">
        <div className="flex flex-col gap-4">
          <h1 className="font-bold font-sans  xl:text-[58px] lg:text-[50px] sm:text-[45px] text-[32px]  text-secondary">
            <span className="text-primary font-serif italic">All-in-One</span> System To <br /> Power Your Business
          </h1>

          <p className=" text-para font-sans xl:text-[18px] sm:text-[14px] text-[12px]">
            The go-to choice for salons, spas, and wellness professionals—trusted <br /> and top-rated by the industry.
          </p>
        </div>

        <div className="pt-10">
            <div className="border-l-4 xl:px-6 px-2 border-[#6E00B7] xl:h-[75px] h-[50px] flex flex-col xl:w-[530px] sm:w-[480px]">
      ...
      <div className="flex gap-6 justify-center items-center ">
          <img src="/Frame 112.png" alt="" className="lg:h-[430px] md:h-[400px] sm:h-[350px] h-[250px]"/>
          <img src="/Frame 36.png" alt="" className="lg:h-[480px] md:h-[450px] sm:h-[400px] h-[320px] "/>
      </div>
        </div>
    </div>
  );

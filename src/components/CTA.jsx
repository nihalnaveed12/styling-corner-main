    ...
    <div className="bg-gradient-to-r relative from-purple-600 via-purple-700 to-purple-800 py-20 px-8 font-sans">
      ...
      <div className="absolute bottom-0 left-0  z-[12]">
        <img
          src="/Ellipse 21.png"
          alt=""
          className="opacity-20 blur-xl w-24 shadow-2xl inset-8 inset-ring-orange-500 rounded-full border-none outline-none shadow-[#D2998D]"
        />
      </div>
      <div className="absolute bottom-0 right-[40%]  z-[12]">
        <img
          src="/Ellipse 21.png"
          alt=""
          className="opacity-20 blur-xl w-46 shadow-2xl inset-8 inset-ring-orange-500 rounded-full border-none outline-none shadow-[#D2998D]"
        />
      </div>
      <div className="absolute top-0 right-0  z-[12]">
        <img
          src="/Ellipse 21.png"
          alt=""
          className="opacity-20 blur-xl w-60 shadow-2xl inset-8 inset-ring-orange-500 rounded-full border-none outline-none shadow-[#D2998D]"
        />
      </div>
    </div>
  );
